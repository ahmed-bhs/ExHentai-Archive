...
final class Version20180907193200 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE exhentai_category (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, oldname VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE exhentai_gallery (id INT NOT NULL, category_id INT NOT NULL, archiver_key_id INT DEFAULT NULL, token VARCHAR(12) NOT NULL, title VARCHAR(1000) DEFAULT NULL, title_japan VARCHAR(1000) DEFAULT NULL, posted DATETIME NOT NULL, uploader VARCHAR(255) DEFAULT NULL, filesize DOUBLE PRECISION DEFAULT NULL, file_count INT NOT NULL, expunged TINYINT(1) DEFAULT NULL, rating DOUBLE PRECISION NOT NULL, torrent_count INT NOT NULL, download_state INT NOT NULL, last_audit DATETIME DEFAULT NULL, INDEX IDX_DD12754512469DE2 (category_id), UNIQUE INDEX UNIQ_DD127545FB7424C8 (archiver_key_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE exhentai_tag (id INT AUTO_INCREMENT NOT NULL, namespace_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_BE6B10B95F74F783 (namespace_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE exhentai_tag_namespace (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exhentai_tag DROP FOREIGN KEY FK_BE6B10B95F74F783');
        $this->addSql('DROP TABLE exhentai_archiver_key');
